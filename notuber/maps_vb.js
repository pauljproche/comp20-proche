...
var contentString, contentAsString, contentAsString2;
...
//marker.setMap(map);
      ...
      contentAsString2 = the_content.join(', ');
      console.log(contentAsString2);

      
      infowindows[i] = new google.maps.InfoWindow();
      curr_info = infowindows[i];
        // Open info window on click 
        google.maps.event.addListener(car_markers[i], 'click', function() {
          //infowindow.setContent(marker.title);
          curr_info.setContent(contentAsString2);
          curr_info.open(map, car_markers[i]);
        });
    }
